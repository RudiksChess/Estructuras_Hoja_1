...
class ReproductorTest {
	...
	@Test
	void test() {
		Reproductor test = new Reproductor(AM,AM_fav,5);
		
		int lol = test.continuar(); 
		assertEquals(2,lol);
		
	}
	@Test
	void test2() {
		Reproductor test = new Reproductor(AM,FM_fav,7);
		
		int lol = test.retroceder(); 
		assertEquals(1,lol);
	...
	@Test
	void test3() {
		Reproductor test = new Reproductor(AM,AM_fav,15);
